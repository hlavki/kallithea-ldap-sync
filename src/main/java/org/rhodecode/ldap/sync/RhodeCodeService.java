...
import org.rhodecode.ldap.sync.jooq.tables.records.UsersGroupsMembersRecord;
import org.rhodecode.ldap.sync.jooq.tables.records.UsersGroupsRecord;
 ...
 */
public class RhodeCodeService {

    private static final Logger log = LoggerFactory.getLogger(RhodeCodeService.class);
    private static final String RC_CREATOR_ID_PROP = "rhodecode.creator.id";
    private static final String RC_USER_GROUP_READ_PERM_ID_PROP = "rhodecode.userGroupReadPerm.id";
    private static final String RC_USER_GROUP_ADMIN_PERM_ID_PROP = "rhodecode.userGroupAdminPerm.id";
    private static final String RC_DEFAULT_USER_ID_PROP = "rhodecode.defaultUser.id";
    private static final String RC_USER_ADMIN_USER_ID_PROP = "rhodecode.adminUser.id";
    private static final String RC_JDBC_DRIVER_PROP = "rhodecode.jdbc.driver";

    protected final Properties config;

    public RhodeCodeService(Properties config) {
        this.config = config;
        try {
