...
Latest snapshots: [kallithea-ldap-sync-0.2.2-SNAPSHOT.tar.gz](https://github.com/hlavki/kallithea-ldap-sync/releases/download/untagged-8e805329c365fa221ac1/kallithea-ldap-sync-0.2.2-SNAPSHOT.tar.gz)
